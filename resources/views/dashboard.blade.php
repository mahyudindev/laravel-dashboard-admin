...
<x-app-layout>
<div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-10"  x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)">
        ...
        </script>   @endif   <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-5" :class="{ 'mt-5': show, 'mt-12': !show }" x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)">
